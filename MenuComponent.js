      ...
      >
        <Pressable onPress={() => navigation.navigate("PizzaMania")}>
          <Image
            ...
            source={{
              uri: "https://www.pikpng.com/pngl/b/103-1036995_veg-pizza-veg-pizza-images-png-clipart.png",
            }}
          />
          <Text style={{textAlign: "center",fontSize:17,color:"white",marginTop:10,}}>Veg Pizza</Text>
        </Pressable>

        <Pressable onPress={() => navigation.navigate("Desert")}>
          <Image
            style={{ width: 80, height: 80, borderRadius: 40 }}
            source={{
        ...
        <Pressable onPress={() => navigation.navigate("VegPizza")}>
          <Image
            style={{ width: 80, height: 80, borderRadius: 40 }}
            source={{
